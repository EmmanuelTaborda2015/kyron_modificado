...
<section>
	<article id="fondo_login"> 
                            ...
                            <input class="login validate[required]"
			type="text" size="30"
			name="<?php echo sha1('usuario'.$_REQUEST['tiempo'])?>"
			id="<?php echo sha1('usuario'.$_REQUEST['tiempo'])?>"
			placeholder="Usuario" value="" /><br /> <input
			class="login validate[required]" type="password" size="30"
			name="<?php echo sha1('clave'.$_REQUEST['tiempo'])?>"
			id="<?php echo sha1('clave'.$_REQUEST['tiempo'])?>"
			placeholder="Contraseña" value="" /><br />
                            <?php
